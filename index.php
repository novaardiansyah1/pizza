    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link active" href="index.php">All Menu</a>
          <a class="nav-item nav-link" href="pizza.php">Pizza</a>
          <a class="nav-item nav-link" href="nasi.php">Nasi</a>
          <a class="nav-item nav-link" href="minuman.php">Minuman</a>
